package com.example.server.eventbus.template;

import com.example.server.eventbus.common.event.ReceiveEvent;
import com.example.server.eventbus.data.TemplateInfo;
import com.example.server.eventbus.template.event.ChangeEvent;
import com.example.server.eventbus.template.event.StateBStartEvent;
import com.example.server.eventbus.template.event.StateBStopEvent;
import com.example.server.eventbus.template.event.StateCStartEvent;
